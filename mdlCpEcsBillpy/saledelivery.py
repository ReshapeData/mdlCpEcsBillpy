...
def saleOut(startDate,endDate,app2,app3,option):
...
def saleOut_byOrder(app2,app3,option,data):
    '''
    按单据同步
    :param startDate:
    :param endDate:
