    ...
    for i in data:
        ...
        try:
            ...
            if exist_order(api_sdk,i[0]['FGODOWNNO'])!=True:
                ...
                insertLog(app3, "其他入库单", str(i[0]['FGODOWNNO']),
                          "数据同步成功", "1")
...
def json_model(app2, model_data):
    ...
    try:
        ...
        model = {
            ...
            # },
            "FSTOCKID": {
                "FNumber": "SK01" if model_data['FSTOCKID']=="苏州总仓" or model_data['FSTOCKID']=="" or model_data['FSTOCKID']=="样品仓" else code_conversion(app2,"rds_vw_warehouse","FNAME",model_data['FSTOCKID'])
            },
            "FSTOCKSTATUSID": {
                "FNumber": "KCZT01_SYS"
            },
...
def otherInStock(startDate,endDate,app2,app3,option):
...
def otherInStock_byOrder(app2,app3,option,data):
    '''
    按单据同步
    :param startDate:
    :param endDate:
