...
def json_model(app2,model_data,api_sdk):
    ...
    if result!=[] and materialId!="":
        ...
        model={
                ...
                "FRefuseFlag": False,
                "FEntity_Link": [{
                    "FEntity_Link_FRuleId":"SalOrder-SalReturnNotice",
...
def associated(app2,app3,api_sdk,option,data):
...
def salesOrderToNoticeReturn(app2Toekn,app3Token,option):
    ...
    if data:
        ...
        result=associated(app2=app2,app3=app3,api_sdk=api_sdk,option=option,data=res)
